...
BASE_COOKIE="s_nr=`date +%s%N | cut -b1-13`; gpw_e24=${START_URL}; s_cc=true; s_sq=[[B]]; oraclelicense=accept-sqldev-cookie"

#------------------
# ダウンロードリンククリック
#------------------
START_URL="http://download.oracle.com/otn/linux/oracle11g/xe/oracle-xe-11.2.0-1.0.x86_64.rpm.zip"
TARGET_URL="${DL_URL}"
